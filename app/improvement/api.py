...
def improvement_run(run_id: str, db: Session = Depends(get_db)) -> ImprovementRunResponse:
    ...
    return ImprovementRunResponse(
        ...
        tier_t1=row.tier_t1,
        tier_t2=row.tier_t2,
        quality_schema_version=row.quality_schema_version,
        evidence_quality_score=row.evidence_quality_score,
        claim_support_coverage=row.claim_support_coverage,
        strong_claim_coverage=row.strong_claim_coverage,
        independent_claim_coverage=row.independent_claim_coverage,
        mean_cited_reliability=row.mean_cited_reliability,
        p25_cited_reliability=row.p25_cited_reliability,
