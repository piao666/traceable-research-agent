...
def _step_template(tool_name: str, task: str) -> dict[str, Any]:
    ...
    return templates[tool_name].copy()
...
def plan_task(
    ...
    if _matches(task_lower, REPORT_KEYWORDS):
        _append_step(steps, notes, "report_writer", task_text, allowed_set)
    ...
    return {
        ...
        "allowed_tools": allowed_tools or DEFAULT_TOOL_ORDER.copy(),
        "steps": steps,
        "notes": notes,
    }
