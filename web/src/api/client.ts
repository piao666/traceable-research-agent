...
export type ResearchResultContextResponse = components["schemas"]["ResearchResultContextResponse"];
export type ResultEvidenceResponse = components["schemas"]["ResultEvidenceResponse"];
...
export const api = {
  ...
  getResultContext: (runId: string, signal?: AbortSignal) => requestJson<ResearchResultContextResponse>(`${taskPath(runId)}/result/context`, { signal }),
  getResultEvidence: (runId: string, signal?: AbortSignal) => requestJson<ResultEvidenceResponse>(`${taskPath(runId)}/result/evidence`, { signal }),
  getResultTrace: (runId: string, signal?: AbortSignal) => requestJson<ToolTraceResponse[]>(`${taskPath(runId)}/result/trace`, { signal }),
