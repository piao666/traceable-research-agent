...
const reasons: Record<string, string> = {
  ...
  finalization_reserve: "探索额度不足，剩余额度为最终报告预留",
  already_fetched_use_source_id: "页面已抓取，应读取已保存正文",
  source_id_is_not_a_file_use_web_fetcher: "来源编号不是本地文件路径",
  unsupported_file_extension_use_web_fetcher: "本地文件工具不支持网页格式",
