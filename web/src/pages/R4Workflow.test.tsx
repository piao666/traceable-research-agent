...
it("navigates from successful plan approval directly to the workbench", async () => {
  vi.spyOn(api, "reviewPlan").mockResolvedValue({ run_id: "fixture", task: "待批计划", status: "waiting_human_plan", preflight: { ready: true, blockers: [], warnings: [], capabilities: { research_profile: "offline", research_environment_ready: true, search_provider: "tavily", offline_mode: true, tavily_configured: false, llm_provider: "qwen", llm_configured: false, react_provider: "qwen", react_configured: false, react_enabled: false, deep_research_enabled: false, report_generation_mode: "deterministic", connectivity_verified: false } }, execution_mode: "planned", steps: [], allowed_tools: [], estimated_total_tokens: 0, estimated_cost: 0 });
